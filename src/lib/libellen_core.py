...
class Config():
    ...
    def __init__(self, store_full_json: bool, store_image: bool, store_image_kind: str,
                max_size: int, max_records: int, max_days: int, save_path: str, out_dir: str,
                kind: str, port: int, timezone: str):
